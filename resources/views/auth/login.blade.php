...
@section('content')
    ...
    <body class="overflow-x-hidden min-h-screen relative">
        ...
        <div class="relative min-h-screen flex items-center justify-center md:justify-end p-4 md:p-6 md:pr-32 lg:pr-40 xl:pr-48">
            <!-- Card del login -->
            <div class="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 p-8 md:p-10 transform hover:scale-[1.01] transition-all duration-300 hover:shadow-amber-200/50">
                
                <!-- Logo text -->
                <div class="text-center mb-8">
                    <h1 class="text-4xl font-unbounded font-bold bg-gradient-to-r from-amber-500 via-yellow-600 to-amber-600 bg-clip-text text-transparent mb-2">
                        INNOVATEX
                    </h1>
                ...
                <div class="mb-8 text-center">
                    <h2 class="text-gray-800 text-2xl mb-2 font-unbounded font-bold">¡Bienvenido!</h2>
                    <p class="text-gray-600 text-sm font-unbounded font-light">
                ...
                <form action="{{ route('autenticarme') }}" method="post" class="space-y-5">
                    ...
                    <!-- Campo de email -->
                    <div class="group">
                        <label for="email" class="text-gray-700 text-sm font-unbounded font-medium mb-2 block">
                            Correo electrónico
                        </label>
                        <div class="relative">
                            <input id="email" name="email"
                                class="text-gray-800 outline-none rounded-xl w-full px-4 py-3.5 border-2 border-gray-300 bg-white
                                ...
                                type="email" required placeholder="ejemplo@email.com">
                        ...
                        @error('email')
                            <p class="font-unbounded text-xs text-red-500 mt-2 flex items-center gap-1">
                    ...
                    <!-- Campo de contraseña -->
                    <div class="group">
                        <label for="password" class="text-gray-700 text-sm font-unbounded font-medium mb-2 block">
                            Contraseña
                        </label>
                        <div class="relative">
                            <input type="password" id="password" name="password"
                                class="password-input text-gray-800 outline-none rounded-xl w-full px-4 py-3.5 border-2 border-gray-300 bg-white
                                       focus:border-amber-500 focus:ring-4 focus:ring-amber-500/20 transition-all duration-300
                                       hover:border-gray-400 placeholder-gray-400
                                       @error('password') border-red-500 focus:border-red-500 focus:ring-red-500/20 @enderror"
                                required placeholder="••••••••">
                            <button type="button"
                                class="toggle-password absolute right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div class="flex justify-end">
                        <a href="#"
                            ...
                            class="text-amber-600 hover:text-amber-700 font-unbounded text-sm font-medium underline-offset-4 hover:underline transition-all">
                    ...
                    <!-- Captcha -->
                    <div class="w-full">
                        <div class="captcha-container bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
                            <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha.site_key') }}"
                                data-callback="onCaptchaSuccess" data-expired-callback="onCaptchaExpired">
                            </div>
                        </div>
                        @error('g-recaptcha-response')
                            <span class="text-red-600 text-sm mt-2 block flex items-center gap-1">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                                {{ $message }}
                    ...
                    <div class="flex flex-col gap-4 pt-2">
                        <button id="loginButton" type="submit"
                            class="relative flex justify-center items-center bg-gradient-to-r from-gray-300 to-gray-400 cursor-not-allowed 
                                   rounded-xl text-base font-unbounded font-semibold text-gray-500 w-full py-3.5 px-4
                                   transition-all duration-300 overflow-hidden group shadow-lg border border-gray-300"
                            disabled>
                        ...
                        <a href="{{ route('auth.google.login') }}"
                            class="flex font-medium justify-center gap-3 items-center bg-white hover:bg-gray-50 
                                   rounded-xl text-base font-unbounded text-gray-700 w-full py-3.5 px-4
                                   border-2 border-gray-300 hover:border-amber-500 hover:shadow-lg hover:shadow-amber-500/20
            ...
            <div id="recoverPasswordModal"
                ...
                <div class="bg-white border border-gray-200 rounded-2xl shadow-2xl p-8 max-w-md w-full transform transition-all animate-fade-in">
                    <div class="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-amber-100 to-yellow-100 rounded-full border border-amber-200">
                        <svg class="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        </svg>
                    </div>
                    <h2 class="text-2xl font-unbounded font-semibold mb-3 text-center text-gray-800">¿Olvidaste tu contraseña?</h2>
                    <p class="text-gray-600 text-center mb-8 font-unbounded">Contacta a tu equipo de tecnología para restablecer tu contraseña</p>
                    <div class="flex gap-3">
                        <button onclick="document.getElementById('recoverPasswordModal').classList.add('hidden')"
                            class="flex-1 bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-white font-unbounded font-bold px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-amber-500/40">
                            Cerrar
                        </button>
                    </div>
                </div>
